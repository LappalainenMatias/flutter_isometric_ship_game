...
import 'package:anki/game_specific/animation/anchor_animation.dart';
...
class GoldenAnchor extends Collectable with Animation {
  ...
  GoldenAnchor(this.topLeft, this.elevation, this._id) {
    _collisionBox = CollisionBox(topLeft, width, elevation);
    animationParts = anchorAnimation;
    dto = GoldenAnchorToDrawingDTO.create(this);
  }
