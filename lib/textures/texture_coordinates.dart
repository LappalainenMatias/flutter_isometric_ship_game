...
final Float32List deathGrassTexture = Float32List.fromList([
  80,
  80 + _textureHeight * deathGrassIndex,
  0,
  120 + _textureHeight * deathGrassIndex,
  80,
  _textureHeight + _textureHeight * deathGrassIndex,
  80,
  80 + _textureHeight * deathGrassIndex,
  0,
  120 + _textureHeight * deathGrassIndex,
  0,
  40 + _textureHeight * deathGrassIndex,
  80,
  80 + _textureHeight * deathGrassIndex,
  0,
  40 + _textureHeight * deathGrassIndex,
...
final Float32List grassTexture = Float32List.fromList([
  80,
  80 + _textureHeight * grassIndex,
  0,
  120 + _textureHeight * grassIndex,
  80,
  _textureHeight + _textureHeight * grassIndex,
  80,
  80 + _textureHeight * grassIndex,
  0,
  120 + _textureHeight * grassIndex,
  0,
  40 + _textureHeight * grassIndex,
  80,
  80 + _textureHeight * grassIndex,
  0,
  40 + _textureHeight * grassIndex,
...
final Float32List rockTexture = Float32List.fromList([
  80,
  80 + _textureHeight * rockIndex,
  0,
  120 + _textureHeight * rockIndex,
  80,
  _textureHeight + _textureHeight * rockIndex,
  80,
  80 + _textureHeight * rockIndex,
  0,
  120 + _textureHeight * rockIndex,
  0,
  40 + _textureHeight * rockIndex,
  80,
  80 + _textureHeight * rockIndex,
  0,
  40 + _textureHeight * rockIndex,
...
final Float32List snowTexture = Float32List.fromList([
  80,
  80 + _textureHeight * snowIndex,
  0,
  120 + _textureHeight * snowIndex,
  80,
  _textureHeight + _textureHeight * snowIndex,
  80,
  80 + _textureHeight * snowIndex,
  0,
  120 + _textureHeight * snowIndex,
  0,
  40 + _textureHeight * snowIndex,
  80,
  80 + _textureHeight * snowIndex,
  0,
  40 + _textureHeight * snowIndex,
  80,
  0 + _textureHeight * snowIndex,
  80,
  80 + _textureHeight * snowIndex,
  80,
  0 + _textureHeight * snowIndex,
...
final Float32List iceTexture = Float32List.fromList([
  80,
  80 + _textureHeight * iceIndex,
  0,
  120 + _textureHeight * iceIndex,
  80,
  _textureHeight + _textureHeight * iceIndex,
  80,
  80 + _textureHeight * iceIndex,
  0,
  120 + _textureHeight * iceIndex,
  0,
  40 + _textureHeight * iceIndex,
  80,
  80 + _textureHeight * iceIndex,
  0,
  40 + _textureHeight * iceIndex,
...
final Float32List sandTexture = Float32List.fromList([
  80,
  80 + _textureHeight * sandIndex,
  0,
  120 + _textureHeight * sandIndex,
  80,
  _textureHeight + _textureHeight * sandIndex,
  80,
  80 + _textureHeight * sandIndex,
  0,
  120 + _textureHeight * sandIndex,
  0,
  40 + _textureHeight * sandIndex,
  80,
  80 + _textureHeight * sandIndex,
  0,
  40 + _textureHeight * sandIndex,
